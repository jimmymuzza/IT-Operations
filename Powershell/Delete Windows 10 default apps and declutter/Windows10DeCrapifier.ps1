...
#-AppAccess		Sets privacy permissions in Settings -> Privacy to restricted by default. Some apps may require these permsissions to function, you can just reenable them from the settings menu.
...
$GoodApps =	"Microsoft.MicrosoftEdge|Windows.PrintDialog|Microsoft.Windows.Cortana|Microsoft.Microsoft3DViewer|Microsoft.Services.Store.Engagement|Microsoft.StorePurchaseApp|Microsoft.Windows.Photos|Microsoft.HEVCVideoExtension|Microsoft.WindowsStore|Microsoft.Print3D|Microsoft.MPEG2VideoExtension|Microsoft.MicrosoftStickyNotes|Microsoft.MicrosoftOfficeHub|Microsoft.WindowsCalculator|Microsoft.MSPaint|Microsoft.FreshPaint"
...
Function RemoveApps {
	$SafeApps = "sechealth|secureas|desktopappinstaller|Edge|Print|Cortana|Photos|HEVC|Store|3D|MPEG2|Notes|Office|Calculator|Paint"
	If ($Xbox) {
...
Function RegSetUser {
	...
	#Do not track - Edge
	Red Add "$reglocation\SOFTWARE\Classes\Local Settings\Software\Microsoft\Windows\CurrentVersion\AppContainer\Storage\microsoft.microsoftedge_8wekyb3d8bbwe\MicrosoftEdge\Main" /T REG_DWORD /V "DoNotTrack" /D 1 /F
	#Do not track - IE
